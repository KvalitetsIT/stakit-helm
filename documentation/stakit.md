...
| backend.podSecurityContext.allowPrivilegeEscalation | bool | `false` |  |
| backend.podSecurityContext.capabilities.drop[0] | string | `"ALL"` |  |
| backend.podSecurityContext.readOnlyRootFilesystem | bool | `true` |  |
| backend.podSecurityContext.runAsGroup | int | `11000` |  |
| backend.podSecurityContext.runAsNonRoot | bool | `true` |  |
| backend.podSecurityContext.runAsUser | int | `11000` |  |
...
| frontend.podSecurityContext.allowPrivilegeEscalation | bool | `false` |  |
| frontend.podSecurityContext.capabilities.drop[0] | string | `"ALL"` |  |
| frontend.podSecurityContext.readOnlyRootFilesystem | bool | `true` |  |
| frontend.podSecurityContext.runAsGroup | int | `11000` |  |
| frontend.podSecurityContext.runAsNonRoot | bool | `true` |  |
| frontend.podSecurityContext.runAsUser | int | `11000` |  |
